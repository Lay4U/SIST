...
public class Ex03_DataType { //파스칼 + 스네이크
	...
	public static void main(String[] args) {
		...
		*/
		...
		System.out.println(b); //5 vs 10 - 복사된 다른 값은 영향을 받지 않는다.
		...
		//byte koreaScore = 100; //타이핑하기 귀찮아서..
		//byte ks = 100;
		...
		//케밥 표기법
		// - 식별자를 만들 때 각 단어의 연결을 -를를 사용해서 표기
		// - 가독성 높음
		//byte english-score;
