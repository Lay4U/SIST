...
public class Ex19_DateTime {
	...
	public static void main(String[] args) {
		...
		ex) 8시간, 10분 -> 시간 -> 한축의 점과 점사이의 거리
		
		- 시간과 시각은 연산의 대상이 된다.(피연산자의 자격이 있다.) -> 산술 연산, 비교 연산
		
		- 시각 + 시각 -> 2021.04.27 09:40 + 2021.04.18 12:30 = X
		- 시각 - 시각 -> 2021.04.18 - 2021.04.17 = O 
		- 시각 * 시각 -> X
		- 시각 / 시각 -> X
		- 시각 % 시각 -> X
	...
	private static void m2() {
		...
		//java.util.GregorianCalendar[time=1617756173187,areFieldsSet=true,areAllFieldsSet=true,lenient=true,zone=sun.util.calendar.ZoneInfo[id="Asia/Seoul",offset=32400000,dstSavings=0,useDaylight=false,transitions=30,lastRule=null],firstDayOfWeek=1,minimalDaysInFirstWeek=1,ERA=1,YEAR=2021,MONTH=3,WEEK_OF_YEAR=15,WEEK_OF_MONTH=2,DAY_OF_MONTH=7,DAY_OF_YEAR=97,DAY_OF_WEEK=4,DAY_OF_WEEK_IN_MONTH=1,AM_PM=0,HOUR=9,HOUR_OF_DAY=9,MINUTE=42,SECOND=53,MILLISECOND=187,ZONE_OFFSET=32400000,DST_OFFSET=0]
