...
public class Ex04_DataType {
	...
	public static void main(String[] args) {
		...
		//CPU -> 64bit, 32bit, 16bit, 8bit .... -> CPU가 한번에 처리하는 데이터의 크기
		...
		String m2 = ""; //빈문자열(Empty String) -> 주로 문자열 변수를 초기화할 때 사용 or 그외 등등..
