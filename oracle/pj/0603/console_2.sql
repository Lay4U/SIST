...
insert into tblteacher(TEACHERSEQ, TEACHERNAME, PASSWORD, TEACHERTEL) values
(SEQ_TBLTEACHER.nextval,'체제원', 1708219, '010-3575-1687');

insert into tblteacher(TEACHERSEQ, TEACHERNAME, PASSWORD, TEACHERTEL) values
(SEQ_TBLTEACHER.nextval,'곽우신', 1708219, '010-3575-1687');
insert into tblteacher(TEACHERSEQ, TEACHERNAME, PASSWORD, TEACHERTEL) values
(SEQ_TBLTEACHER.nextval,'이응수', 1708219, '010-3575-1687');
insert into tblteacher(TEACHERSEQ, TEACHERNAME, PASSWORD, TEACHERTEL) values
(SEQ_TBLTEACHER.nextval,'이창익', 1708219, '010-3575-1687');
insert into tblteacher(TEACHERSEQ, TEACHERNAME, PASSWORD, TEACHERTEL) values
(SEQ_TBLTEACHER.nextval,'박세인', 1708219, '010-3575-1687');
insert into tblteacher(TEACHERSEQ, TEACHERNAME, PASSWORD, TEACHERTEL) values
(SEQ_TBLTEACHER.nextval,'이규미', 2708219, '010-3575-1687');
insert into tblteacher(TEACHERSEQ, TEACHERNAME, PASSWORD, TEACHERTEL) values
(SEQ_TBLTEACHER.nextval,'김호진', 1708219, '010-3575-1687');
insert into tblteacher(TEACHERSEQ, TEACHERNAME, PASSWORD, TEACHERTEL) values
(SEQ_TBLTEACHER.nextval,'김현룡', 1708219, '010-3575-1687');
insert into tblteacher(TEACHERSEQ, TEACHERNAME, PASSWORD, TEACHERTEL) values
(SEQ_TBLTEACHER.nextval,'김대기', 1708219, '010-3575-1687');
insert into tblteacher(TEACHERSEQ, TEACHERNAME, PASSWORD, TEACHERTEL) values
(SEQ_TBLTEACHER.nextval,'한장희', 1708219, '010-3575-1687');
