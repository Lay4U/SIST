	...
	<section class="main-section">
		...
		<form method="POST" action="/myapp/board/editok.do">
			<table class="table table-bordered">
				<tr>
					<th>제목</th>
					<td><input type="text" name="subject" class="form-control" id="subject"
						required value="${dto.subject}"></td>
				</tr>
				<tr>
					<th>내용</th>
					<td><textarea name="content" class="form-control" id="content"
			...
			<div class="btns">
				...
				<button type="button" class="btn btn-default short"
