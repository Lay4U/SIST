...
//		System.out.println("search:" + search);
		...
		// 2page -> where rnum between 11 and 11
...
//		loop = 1;
//		n = ((nowPage - 1) / blockSize) * blockSize + 1; //1, 11, 21, 31을 가져옴
//		if (n == 1) {
...
//		}
		...
		if (n == 1) {
			...
			pagebar += String.format(" <li><a href='/myapp/board/list.do?page=%d'> <span aria-hidden='true'>&laquo;</span></a></li>", n-1);
		}
