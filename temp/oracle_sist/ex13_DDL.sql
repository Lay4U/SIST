...
6. default
    - 기본값 설정
    - 해당 컬럼값이 null이면 대신 미리 준비한 기본값을 대입한다.
...
-- ORA-01400: NULL을 ("HR"."TBLMEMO"."NAME") 안에 삽입할 수 없습니다
insert into tblMemo (seq, name, memo, regdate) values (1, null, '메모입니다.', sysdate); 
...
-- 현재 상태는 레코드을 구분할 방법이 없다******
-- ORA-00001: 무결성 제약 조건(HR.SYS_C007582)에 위배됩니다
insert into tblMemo (seq, name, memo, regdate) values (1, '홍길동', '메모입니다.', sysdate); 
...
-- ORA-00001: 무결성 제약 조건(HR.SYS_C007584)에 위배됩니다
...
-- ORA-02290: 체크 제약조건(HR.SYS_C007586)이 위배되었습니다
...
insert into tblMemo (seq, name, memo, regdate) values (1, '홍길동홍길동홍길동', '메모입메모입메모입메모입메모입메모입메모입메모입메모입메모입메모입', sysdate);
