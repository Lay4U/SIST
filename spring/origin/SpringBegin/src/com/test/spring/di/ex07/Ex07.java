...
public class Ex07 {
	...
	public static void main(String[] args) {
		...
		//자바 방식: Ex07 입장에서는 Service 객체만 필요하다. 하지만, Service 객체의 의존 객체인 File 객체까지 만들어야 한다. 가독성이 떨어진다. ? File 객체의 존재가 애매하기 때문에.. File 객체는 Ex07에겐 직접적으로 필요하지 않은 객체라서..
		//스프링 방식: Ex07이 Service 객체만 만들었다. File 객체의 생성과 Service 객체하고의 관계는 전부 XML에서 처리한다. Ex07이 Service 객체에만 집중할 수 있는 환경을 만들어준다.
